...
const EnhancedHero = () => {
  ...
  return (
    <section id="home" className="min-h-screen flex items-center relative overflow-hidden bg-gradient-to-br from-background via-muted/20 to-background">
      ...
      <motion.div 
        ...
        className="absolute left-8 top-1/2 transform -translate-y-1/2 flex flex-col space-y-4 z-20"
      >
        {[
          { icon: Github, href: "#", color: "hover:text-gray-800" },
          { icon: Linkedin, href: "#", color: "hover:text-blue-600" },
          { icon: FileText, href: "#", color: "hover:text-green-600" }
        ].map((social, index) => (
          <motion.a
            key={index}
            href={social.href}
            ...
            whileTap={{ scale: 0.9 }}
            className={`p-3 bg-white/10 backdrop-blur-md rounded-full ${social.color} transition-colors duration-300`}
          >
      ...
      <div className="container mx-auto px-4 grid lg:grid-cols-2 gap-12 items-center relative z-10">
        ...
        <div className="space-y-8">
          ...
          >
            ...
            >
              {currentText === 0 && (
                <span className="gradient-text bg-gradient-to-r from-primary via-accent to-primary bg-[length:200%_100%] bg-clip-text text-transparent">
                  {texts[0]}
                </span>
              )}
              {currentText === 1 && (
        ...
        >
          ...
          >
            ...
            {[...Array(6)].map((_, i) => (
              <motion.div
                key={i}
                className={`absolute w-${2 + i % 3} h-${2 + i % 3} bg-gradient-to-r from-primary/30 to-accent/30 rounded-full`}
                animate={{
                  y: [0, -20, 0],
                  rotate: [0, 360],
                }}
